...
public class Surface : MonoBehaviour {
	...
	protected void Awake() {
		...
		if (colliderCamera == null)
			colliderCamera = GameObject.Find("ColliderCamera").GetComponent<Camera>();
	}
	...
	private void CreateSurfaceCursor(Pointer pointer) {
		...
		Ray ray = colliderCamera.ScreenPointToRay(pointer.Position);
		...
		Vector2 position = colliderCamera.ScreenToWorldPoint(pointer.Position);
